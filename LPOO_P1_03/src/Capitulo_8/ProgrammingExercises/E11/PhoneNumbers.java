package Capitulo_8.ProgrammingExercises.E11;
...
public class PhoneNumbers {
	...
	public static void main(String[] args) {
		...
		d.add("luis", "9512223162");
		d.add("angel", "9512364852");
		d.add("lukaz", "9512458695");
		d.add("darwin", "9512451236");
		d.add("glenn", "9518465484");
		d.add("vizard", "9516548451");
		d.add("yakelin", "9516589445");
		d.add("biaani", "9512453215");
		d.add("yesenia", "9512801112");
		d.add("karina", "9512587663");
		int i = 0;
		while (i < 30) {
