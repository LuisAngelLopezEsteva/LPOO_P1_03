package Capitulo_8.ProgrammingExercises.E12;
...
public class CertificateOfDeposit {
	...
	public String getIssueDate() {
		return (issueDate.get(Calendar.MONTH) + 1) + "/" + issueDate.get(Calendar.DAY_OF_MONTH) + "/"
				+ issueDate.get(Calendar.YEAR);
	}

	public String getMaturityDate() {
		return (maturityDate.get(Calendar.MONTH) + 1) + "/" + maturityDate.get(Calendar.DAY_OF_MONTH) + "/"
	...
	// Constructor
	CertificateOfDeposit(int certNum, String lastName, double bal, int year, int month, int day) {
